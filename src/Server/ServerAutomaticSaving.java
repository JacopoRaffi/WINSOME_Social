...
public class ServerAutomaticSaving extends Thread {
    private File postStatus;
    private File usersStatus;
    private ServerWinsomeSocial social;
    private final long timelapse;

    public ServerAutomaticSaving(ServerWinsomeSocial social, File usersStatus, File postStatuss, long timeLapse){
        this.social = social;
